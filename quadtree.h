...
public:
     ...
     */
    void render_helper(Node *curr, PNG &im) const;
    ...
    /**
     * Rounds down the number to the biggest power of two
    */

    /**
     * Recursive Prune helper
    */
    void prune_helper(Node* curr, const int tol);
    long roundDownToPowerOf2(int n);
    ...
    int pruneSizeHelper(Node* curr, const int tol) const;
...
private:
    ...
    double maxTol(Node* node, double mx) const;
    ...
    /**
     * Helper to destroy all dynamically allocated mem
     */
    void clear_helper(Node *currNode);
